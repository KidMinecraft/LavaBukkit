    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            if (var11 == 0)
            {
                ...
                org.bukkit.block.Block blockClicked = par3World.isRemote ? null : par3World.getWorld().getBlockAt(par4, par5, par6);
                Player thePlayer = par3World.isRemote ? null : (Player) par2EntityPlayer.getBukkitEntity();
                ...
                CraftBlockState blockState = par3World.isRemote ? null : CraftBlockState.getBlockState(par3World, par4, par5, par6);
                // CraftBukkit end
