...
public class CraftContainer extends Container {
    ...
    @Override
    public boolean isPlayerNotUsingContainer(EntityPlayer entityhuman) { // TODO O_O wtf
        ...
        if (view.getPlayer() instanceof CraftPlayer) {
            ...
            int size = getSize();
            player.getHandle().playerNetServerHandler.sendPacketToPlayer(new Packet100OpenWindow(this.windowId, type, cachedTitle, size));
